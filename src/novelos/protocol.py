...
# 错误码注册表（冻结文档 04 §4）。USAGE_ERROR 由 04 r6 登记（CLI 解析层，退出码 4）；
# OUTPUT_PATH_NOT_ALLOWED / UNEXPECTED_OUTPUT_FILE 由 04 r7 实现期回写登记（退出码 1，
# Agent 可自修复——04 §4 末行：自修复只允许退出码 1）。
...
# Goal 2 领域码（§4 冻结表既有登记）
TASK_NOT_FOUND = "TASK_NOT_FOUND"
VALIDATION_FAILED = "VALIDATION_FAILED"
STALE_INPUT = "STALE_INPUT"
NO_PENDING_DECISION = "NO_PENDING_DECISION"
DECISION_NONCE_INVALID = "DECISION_NONCE_INVALID"
DECISION_NONCE_CONSUMED = "DECISION_NONCE_CONSUMED"
CANDIDATE_TAMPERED = "CANDIDATE_TAMPERED"
# 04 r7 新增登记
OUTPUT_PATH_NOT_ALLOWED = "OUTPUT_PATH_NOT_ALLOWED"
UNEXPECTED_OUTPUT_FILE = "UNEXPECTED_OUTPUT_FILE"
